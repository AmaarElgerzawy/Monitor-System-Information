...
class QRoundProgressBar(QtWidgets.QWidget):
    ...
    def paintEvent(self, event):
        ...
        buffer = QtGui.QImage(outerRadius, outerRadius, QtGui.QImage.Format.Format_ARGB32)
        buffer.fill(0)
    ...
    def drawValue(self, p, baseRect, value, arcLength):
        ...
        dataPath.setFillRule(Qt.FillRule.WindingFill)
    ...
    def drawText(self, p, innerRect, innerRadius, value):
        ...
        p.drawText(textRect, Qt.AlignmentFlag.AlignCenter, text)
    ...
    def rebuildDataBrushIfNeeded(self):
        if self.rebuildBrush:
            ...
            dataBrush.setCoordinateMode(QtGui.QGradient.CoordinateMode.StretchToDeviceMode)
            ...
            p = self.palette()
            p.setBrush(QtGui.QPalette.ColorRole.Highlight, dataBrush)
            self.setPalette(p)
